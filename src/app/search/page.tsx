                ...
                <Link key={movie.id} href={`/${movie.id}`}>
                  <div className="bg-secondary rounded-[8px] overflow-hidden w-[160px] h-[320px] cursor-pointer hover:opacity-50 easin">
                    ...
                    <div className="flex p-2 flex-col items-start">
                      ...
                      <p className="text-wrap">{movie.original_title.length > 25
          ...
          <div className="sticky top-24">
            ...
            <div className="w-[387px] flex items-start content-start gap-4 self-stretch flex-wrap">
              {genres?.map((d: GenreType) => (
                <button
                  key={d.id}
                  onClick={() => handleGenreClick(d.id.toString())}
                  className="w-[87px] gap-4 self-stretch bg-secondary hover:bg-accent p-2 rounded-lg text-center"
                >
                  {d.name}
                </button>
              ))}
